...
import { experience } from './contansts/projects'
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black bg-opacity-80 text-green-400 p-4 font-mono relative">
      <MatrixBackground />
      <div className={`flex w-full ${center} justify-center items-center `}>
        <div className='z-10 '>
          {!showWindow && (
      ...
      {showWindow && (
        ...
        <motion.div className="mx-auto border border-green-400 rounded-lg overflow-hidden relative z-10 max-w-4xl w-full bg-black bg-opacity-90">
          ...
          <div className="p-4">
            ...
            {showProjects && (
              <div className="mb-8">
                <p className="mb-2">$ ls experience/</p>
                <div className="pl-4 space-y-4">
                  {experience.map((exp, index) => (
                    <div key={index} className="border border-green-400 p-4 rounded">
                      <h3 className="text-lg font-semibold mb-1">
                        <TypeWriter text={exp.title} delay={50} />
                      </h3>
                      <p className="text-green-200 mb-2">
                        <TypeWriter text={exp.description} delay={20} />
                      </p>
